...
class CategoryController {
    ...
    private static final class Routes {
        ...
        private static final String CATEGORY_POSITION = CATEGORY_BY_UUID + "/position";
    }
    ...
    @PatchMapping(Routes.CATEGORY_POSITION)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void updateCategoryPosition(@PathVariable final UUID languageUuid,
                                @PathVariable final UUID uuid,
                                @RequestBody @Valid final UpdateCategoryPositionForm form) {
